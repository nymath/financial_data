...
if __name__ == "__main__":
	try:
		...
		if code==200:
			...
			print (result)
		#方式2，调取数据后写入csv格式文件
		url2='/api/master/getSecID.csv?field=&assetClass=&ticker=688001,000001&partyID=&cnSpell='    #url2须为csv格式才可使用GBK编码，即将url1中的.json替换为.csv
